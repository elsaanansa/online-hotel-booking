                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                   ...
                                   <textarea name="privacy_content" class="form-control snote" cols="30" rows="10">{{ $page_data->about_content }}</textarea>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label">Status *</label>
                                  <select name="privacy_status" class="form-control">
                                  <option value="1" @if ($page_data->privacy_status == 1) @endif>Show</option>
                                  <option value="0" @if ($page_data->privacy_status == 0) @endif>Hide</option>
                                  </select>
                                </div>
