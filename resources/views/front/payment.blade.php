        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 checkout-left mb_30">
                    ...
                    <div class="row d-flex w-full mt-4">
                            ...
                            <div class="stripe mt_20">
                                ...
                                <form action="{{ route('stripe', $price_in_dollars) }}" method="post">
                                    ...
                                    <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="{{ $stripe_publishable_key }}"
                                        data-amount="{{ $cents }}" data-name="{{ env('APP_NAME') }}" data-description=""
                                        data-image="{{ asset('uploads/stripe.png') }}" data-currency="usd" data-email="{{ $customer_email }}"></script>
                                </form>
                            </div>
                                    ...
                                    @foreach ($arr_cart_room_id as $i => $room_id)
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <br>
                                                Adult: {{ $arr_cart_adult[$i] ?? 0 }}, Children:
                                                {{ $arr_cart_children[$i] ?? 0 }}
                                            </td>
                                            <td class="p_price">
                                                @php
                                                    $d1 = explode('/', $arr_cart_checkin_date[$i]);
