...
<head>
    ...
    <style>
        ...
        .slide-carousel.owl-carausel .owl-nav .owl-next:hover,
        ...
        .scroll-top,
        .room-detail .right .widgrt .book-now {
                    ...
                    <ul class="right">
                        @if ($global_page_data->cart_status == 1)
                            <li class="menu"><a href="{{ route('cart') }}">{{ $global_page_data->cart_heading }}
                                    @if (session()->has('cart_room_id') && is_array(session()->get('cart_room_id')))
                                        <sup class="">{{ count(session()->get('cart_room_id')) }}</sup>
                                    @endif
                                </a></li>
                        @endif
                        ...
                        @if ($global_page_data->checkout_status == 1)
                            <li class="menu"><a
                                    href="{{ route('checkout') }}">{{ $global_page_data->checkout_heading }}</a></li>
                        @endif
                    ...
                    <div class="item">
                        ...
                        <ul class="social">
                            ...
                            @if ($global_setting_data->linkedin != '')
                                <li><a href="{{ $global_setting_data->linkedin }}"><i class="fa fa-linkedin"></i></a>
                                </li>
                            @endif

                            @if ($global_setting_data->pinterest != '')
                                <li><a href="{{ $global_setting_data->pinterest }}"><i
