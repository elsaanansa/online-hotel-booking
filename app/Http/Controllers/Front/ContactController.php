...
// const SUCCESS_CONTACT = 'Pesan kontak berhasil dikirim';
...
$validator = Validator::make($request->all(), [
        ...
        $message = 'Visitor email in information: <br>';
        ...
        return response()->json(['code'=> 1, 'success_message'=>'Email is sent succesfully']);
}
    }
