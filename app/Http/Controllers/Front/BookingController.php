...
class BookingController extends Controller
{
    ...
    public function paypal($final_price)
    {
        ...
        $secret = 'EGCIh5WeW6SNX0iiPnQuFbAC3AD0oD7EZOzOf92qOMk9r3wcIJ0MIKqK3mbelBf7kzFO1_Eelw9u_xP_';
        $apiContext = new \PayPal\Rest\ApiContext(
            new \PayPal\Auth\OAuthTokenCredential(
                'AaR8k2STvMZivADX5EaWp4akx-9y_o-RN8zcrMEOUIKDGlLssTfDIr2v_0bHQesKeyZsMlQ8FhjrfOer',
                'EGCIh5WeW6SNX0iiPnQuFbAC3AD0oD7EZOzOf92qOMk9r3wcIJ0MIKqK3mbelBf7kzFO1_Eelw9u_xP_'
            )
        );
    ...
    {
        $stripe_secret_key = 'sk_test_51O8gHyGMon457AwD691iiqA3hCn6OO9ZUU4db5LbdgMh5H6YhRxSeRYVqfhtIiYuIooRxKVxXUnZN1jFSF0yE4JQ00zwPQx0WZ';

        $intfinalprice = intval($final_price);
        $cents = $intfinalprice * 100;
